...
public class SettingsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image = MapsActivity.profile_image;
        ...
        edit_name.setText(MapsActivity.setup_name);
        edit_age.setText(Integer.toString(MapsActivity.setup_age));

        String[] items = new String[]{"Female", "Male"};
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, items);
        edit_gender.setAdapter(adapter);
        edit_gender.setSelection(MapsActivity.setup_gender ? 1 : 0);
    ...
    private void save() {
        ...
        MapsActivity.profile_image = profile_image;
        ...
        MapsActivity.last_maps.applySettings();
        finish();
    }
